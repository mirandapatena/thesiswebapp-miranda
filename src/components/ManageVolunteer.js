                ...
                {this.state.volunteers?
                    <Table celled>
                     ...
                     {this.state.volunteerProfiles.filter(searchUser(this.state.search)).map(volunteer => {
                        return(
                        <DeleteUserAccount user_type={volunteer.user_type} firstName={volunteer.firstName} lastName={volunteer.lastName} contactNumber={volunteer.contactNumber} email={volunteer.email} password={volunteer.password} uid={volunteer.key} delete={this.delete}/>);
                    })}
                        </Table.Body>
                    </Table>
                :!this.state.volunteers?
